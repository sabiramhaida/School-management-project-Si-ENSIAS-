...
CREATE TABLE  "AFFECTER" 
   (	"ID_MATERIEL" NUMBER NOT NULL ENABLE, 
	"ID_DEPARTEMENT" NUMBER, 
	"DATE_AFFECTATION" VARCHAR2(4000) NOT NULL ENABLE, 
...
CREATE TABLE  "DEMANDE" 
   (	"ID_DEPT" NUMBER, 
	...
	"DECISION" VARCHAR2(4000), 
	 CONSTRAINT "DEMANDE_CON" PRIMARY KEY ("ID_DEPT", "CATEGORIE", "DATE_DEMANDE") ENABLE, 
...
CREATE TABLE  "REFORMATION" 
   (	"ID_MATERIEL" NUMBER, 
	...
	"ETATACCEPT" VARCHAR2(4000), 
	 CONSTRAINT "REFORMATION_CON" PRIMARY KEY ("ID_MATERIEL", "ID_DEPARTEMENT", "DATE_REFORME") ENABLE
   )
/
CREATE UNIQUE INDEX  "ADHERENT_PK" ON  "ADHERENT" ("ID_ADHERENT")
/
CREATE UNIQUE INDEX  "AFFECTER_CON" ON  "AFFECTER" ("ID_MATERIEL", "ID_DEPARTEMENT", "DATE_AFFECTATION")
/
CREATE UNIQUE INDEX  "AUTEUR_PK" ON  "AUTEUR" ("ID_AUTEUR")
/
CREATE UNIQUE INDEX  "CATEGORIE_CON" ON  "CATEGORIE" ("CATEGORIE")
/
CREATE UNIQUE INDEX  "DEMANDE_CON" ON  "DEMANDE" ("ID_DEPT", "CATEGORIE", "DATE_DEMANDE")
/
...
/
CREATE UNIQUE INDEX  "GERER_CON" ON  "GERER" ("ID_DEPARTEMENT", "ID_RESPONSABLE", "DATE_DEBUT")
/
...
/
CREATE UNIQUE INDEX  "REFORMATION_CON" ON  "REFORMATION" ("ID_MATERIEL", "ID_DEPARTEMENT", "DATE_REFORME")
/
...
/
 CREATE SEQUENCE   "CATEGORIE_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "DEMANDE_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "DEPARTEMENT_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE
/
...
/
 CREATE SEQUENCE   "LIVRE_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "MATERIEL_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "RESPONSABLE_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE
/
